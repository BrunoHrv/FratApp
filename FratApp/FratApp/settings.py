"""
Django settings for FratApp project.
...
SECRET_KEY = 'pf9)f3870ukgi1eo@w3_nm3k1t*s-=z(zv+2i9r%f3n8rf8ele'
...
EMAIL_PORT = 465
EMAIL_HOST_USER = 'fratapprpi@gmail.com'
EMAIL_HOST_PASSWORD = 'HarmonyFratApp'
